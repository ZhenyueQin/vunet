...
python main.py --config deepfashion.yaml --likelihood_loss vgg_perception --to_use_imgn true --checkpoint /flush2/liu162/Zhenyue-Qin/Project-Wukong-V-U-Net/log/2019-03-01T18-52-32/checkpoints/model.ckpt-88000
