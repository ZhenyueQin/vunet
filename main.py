...
class Model(object):
    ...
    def train_forward_pass(self, x, c, xn, cn, dropout_p, init=False):
        print('what is x in train forward pass: ', x)
        print('what is c in train forward pass: ', c)
        print('what is xn in train forward pass: ', xn)
        print('what is cn in train forward pass: ', cn)
